...
const config = {
    ...
    plugins: [
        ['@docusaurus/plugin-content-blog', {
            ...
            blogDescription: 'Irostub 블로그에 어서오세요! 잡글, 연간회고 등 다양한 포스트가 기다리고있어요!',
            path: './irostub',
            feedOptions: {
                type: 'all',
                copyright: 'Copyright © 2023 Rainbow-Flavor, written by Hank & Irostub.',
                language: 'kr'
            }
        }],
        ['@docusaurus/plugin-content-blog', {
    ...
    /** @type {import('@docusaurus/preset-classic').ThemeConfig} */
        {
            ...
            metadata: [
                ...
                {
                    name: 'description',
                    content: 'FB DEVELO4\'s BLOG 에 어서오세요! Front 와 BackEnd 기술 문서와 간단한 블로깅을 함께하고 있습니다!'
                },
